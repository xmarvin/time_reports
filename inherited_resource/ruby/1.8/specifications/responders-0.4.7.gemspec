...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "MIT-LICENSE", "README.rdoc", "Rakefile", "lib/responders.rb", "lib/responders/flash_responder.rb", "lib/responders/http_cache_responder.rb", "lib/responders/version.rb", "test/flash_responder_test.rb", "test/http_cache_responder_test.rb", "test/test_helper.rb"]
