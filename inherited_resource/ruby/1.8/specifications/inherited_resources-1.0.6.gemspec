...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "MIT-LICENSE", "README.rdoc", "Rakefile", "lib/inherited_resources.rb", "lib/inherited_resources/actions.rb", "lib/inherited_resources/base.rb", "lib/inherited_resources/base_helpers.rb", "lib/inherited_resources/belongs_to_helpers.rb", "lib/inherited_resources/blank_slate.rb", "lib/inherited_resources/class_methods.rb", "lib/inherited_resources/dsl.rb", "lib/inherited_resources/legacy/respond_to.rb", "lib/inherited_resources/legacy/responder.rb", "lib/inherited_resources/locales/en.yml", "lib/inherited_resources/polymorphic_helpers.rb", "lib/inherited_resources/responder.rb", "lib/inherited_resources/singleton_helpers.rb", "lib/inherited_resources/url_helpers.rb", "lib/inherited_resources/version.rb", "rails/init.rb", "test/aliases_test.rb", "test/association_chain_test.rb", "test/base_test.rb", "test/belongs_to_test.rb", "test/class_methods_test.rb", "test/customized_base_test.rb", "test/customized_belongs_to_test.rb", "test/defaults_test.rb", "test/nested_belongs_to_test.rb", "test/optional_belongs_to_test.rb", "test/polymorphic_test.rb", "test/redirect_to_test.rb", "test/respond_to_test.rb", "test/singleton_test.rb", "test/test_helper.rb", "test/url_helpers_test.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<responders>, ["~> 0.4.6"])
      s.add_runtime_dependency(%q<has_scope>, ["~> 0.5.0"])
    else
      s.add_dependency(%q<responders>, ["~> 0.4.6"])
